...
if(.not. h % exist('/test')) error stop "/test does not exist: create group failed"

call h%write('/test/group3/scalar', 1_int32)

call h%write('/test/group3/scalar_real', 1._real32)

if(.not. h%exist('/test/group3/scalar')) error stop "/test/group3/scalar does not exist: create group failed"
