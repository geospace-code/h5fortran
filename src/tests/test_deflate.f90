...
call h5f%open(fn1, action='w', comp_lvl=1, debug=.true.)
...
call h5f%open(fn1, action='r', debug=.false.)
...
call h5f%open(fn2, action='w',comp_lvl=1, debug=.true.)
...
call h5f%open(fn3, action='w',comp_lvl=1, debug=.true.)
...
call h5f%open(fn4, action='w',comp_lvl=1, debug=.true.)
