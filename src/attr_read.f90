...
subroutine readattr_char_scalar(self, obj_name, attr_name, attr_id, type_id, Lbuf, A)
...
end subroutine readattr_char_scalar
...
if(is_vlen) then
  ...
  call readattr_char_scalar(self, obj_name, attr_name, attr_id, type_id, Lbuf, A)
endif
